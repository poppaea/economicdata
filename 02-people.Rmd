...
if (knitr:::is_latex_output()) {
  knitr::include_graphics("_resources/chapter_people/gettingpopdata.png")
} else {
  knitr::include_graphics("https://www.hhsievertsen.net/economicdata/chapter_people/gettingpopdata.gif")
}
```
...
if (knitr:::is_latex_output()) {
   knitr::include_graphics("_resources/chapter_people/visualisingdata1.png")
} else {
  knitr::include_graphics("https://www.hhsievertsen.net/economicdata/chapter_people/visualisingdata1.gif")
}
```
...
if (knitr:::is_latex_output()) {
   knitr::include_graphics("_resources/chapter_people/sorted.png")
} else {
  knitr::include_graphics("https://www.hhsievertsen.net/economicdata/chapter_people/sorted.gif")
}
```
...
if (knitr:::is_latex_output()) {
    knitr::include_graphics(c("_resources/chapter_people/nicechart.png"))
} else {
  knitr::include_graphics(c("https://www.hhsievertsen.net/economicdata/chapter_people/nicechart.gif","_resources/chapter_people/nicechart.png"))
}
...
if (knitr:::is_latex_output()) {
  knitr::include_graphics(c("_resources/chapter_people/nice1.png"))
} else {
  knitr::include_graphics(c("https://www.hhsievertsen.net/economicdata/chapter_people/nicechartcombined.gif","_resources/chapter_people/nice1.png"))
}
```
...
if (knitr:::is_latex_output()) {
  knitr::include_graphics(c("_resources/chapter_people/stacked.png"))
} else {
  knitr::include_graphics(c("https://www.hhsievertsen.net/economicdata/chapter_people/stacked.gif","_resources/chapter_people/stacked.png"))
}
```
...
if (knitr:::is_latex_output()) {
   knitr::include_graphics(c("_resources/chapter_people/index.png"))
} else {
  knitr::include_graphics(c("https://www.hhsievertsen.net/economicdata/chapter_people/index.gif","_resources/chapter_people/index.png"))
}
...
if (knitr:::is_latex_output()) {
   knitr::include_graphics(c("_resources/chapter_people/tableb.png"))
} else {
  knitr::include_graphics(c("https://www.hhsievertsen.net/economicdata/chapter_people/table.gif","_resources/chapter_people/tableb.png"))
}
```
...
```{r popflows, echo=FALSE, out.width = '80%',fig.show='hold',fig.align='center',fig.cap="Annual changes in the  population of the United Kingdom in terms of net migration (immigration minus emigration) and the natural population change (births minus deaths). Data source: Eurostat."}
...
```{r pyramid, echo=FALSE, out.width = '80%',fig.show='hold',fig.align='center',fig.cap="Showing the age composition of the UK population by gender. Data source: Eurostat. [Here is a video where I show how I created this chart in MS Excel.](https://youtu.be/AW7sdaJRbtc)"}
knitr::include_graphics(c("_resources/chapter_people/pyramid.png"))
```
