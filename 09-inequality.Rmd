...
a<-ggplot(data=df,aes(x=income)) + 
  geom_histogram( bins=100,fill="black", col="white")
```

```{r inx, echo=FALSE, fig.width=6,fig.align = 'center', fig.height=3,fig.cap="\\label{fig:figx} A simulated income distribution"}
# Show the graph here
a
...
```{r inx2, echo=FALSE, fig.width=6,fig.align = 'center', fig.height=3,fig.cap="\\label{fig:figx} Income shares in the UK. Data source: World Inequality database"}
# Show the graph here
c
