...
```{r , echo=FALSE, results='asis'}
cat('Table: (\\#tab:price6) Laspeyre and Paasche index, unchained and chain-linked. Notes: $I^L$ refers to the Laspeyre price index,  $I^P$ refers to the Paasche price index, $I^{CL}$ refers to the chain-linked Laspeyre index and $I^{CP}$ to the chain-linked Paasche index.
