...
#### Maps
Showing data in maps can provide new insights and reveal patterns. For example that cholera deaths are clustered around pumps like in the map created by John Snow, as shown in Figure \@ref(fig:viz). 

```{r viz11, echo=FALSE, out.width = '80%',fig.show='hold',fig.align='center',fig.cap="John Snow's map of Cholera deaths in central London. Each line represents a death.Each circle represents a water pump. Source: [Wikipedia](https://en.wikipedia.org/wiki/John_Snow#/media/File:Snow-cholera-map-1.jpg). "}
